    ...
    return (
        ...
        >
            <Card className="card-form" bordered={false}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <TextField required label="User name" name="username" />
                    </Col>
                    <Col span={12}>
                ...
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        <TextField required label="Phone" name="phone" type="number" />
                    </Col>
                </Row>
                <Row gutter={16}>
                    <Col span={12}>
                        <DropdownField options={jobData} required label="Job" name={[ 'job', 'id' ]} />
                    </Col>
                    <Col span={12}>
                        <DropdownField
