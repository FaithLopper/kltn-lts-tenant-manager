...
import { DATE_DISPLAY_FORMAT, DATE_INPUT_FORMAT, DATE_SHORT_MONTH_FORMAT, THEMES } from '@constants';
...
export const convertStringToDateTime = (
    strFormDateTime,
    fromFormat = DATE_INPUT_FORMAT,
    toFormat = DATE_INPUT_FORMAT,
) => {
    try {
...
export const  validateStringPath =( input ) => {
