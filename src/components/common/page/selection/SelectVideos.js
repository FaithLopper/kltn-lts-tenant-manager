...
import styles from './SelectVideos.module.scss';
...
function SelectVideos({ title, onSelected, description, excludeIds, loading, selectRow }) {
    ...
    const {
        ...
        apiConfig: apiConfig.mediaLibrary.video,
        options: {
            objectName: 'video',
            pageSize: 5,
        },
    ...
    const columns = [
        {
            ...
            render: (dataRow) => {
                ...
                return <img style={{ width: 160 }} src={thumbnailUrl} />;
            },
        },
        {
            title: 'Title',
        ...
        <ListPage
            ...
            table={
                <BaseTable
                    ...
                    loading={loading || getCategoriesLoading || getVideosLoading}
                    dataSource={data}
                    columns={columns}
                />
            }
